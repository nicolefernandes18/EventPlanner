...
/**
 * Created by Fascel on 12-04-2018.
 */

public class ToDoListAdapters extends RecyclerView.Adapter<ToDoListAdapters.ToDoListViewHolder> {
    List<ToDoData> ToDoDataArrayList = new ArrayList<ToDoData>();
    Context context;

    public ToDoListAdapters(String details) {
        ToDoData toDoData = new ToDoData();
        toDoData.setToDoTaskDetails(details);
        ToDoDataArrayList.add(toDoData);
    }

    public ToDoListAdapters(ArrayList<ToDoData> toDoDataArrayList, Context context) {
    ...
    public ToDoListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.content_manage_tasks, parent, false);
